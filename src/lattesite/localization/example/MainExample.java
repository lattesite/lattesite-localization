...
public class MainExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        locales.add(new LocaleEN("https://www.domain.com/"));
        locales.add(new LocaleSV("https://www.domain.se/"));
        locales.add(new LocaleDE("https://www.domain.com/de/"));
        locales.add(new Locale("fr", "https://www.domain.com/fr/")); // Custom locale "fr"
